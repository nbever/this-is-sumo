...
public class WavefrontObject {
	...
	public void parse(String fileName)  
	{
		...
		logger.info("Loaded OBJ from file '"+fileName+"'");
		logger.info(getVertices().size()+" vertices.");
		logger.info(getNormals().size()+" normals.");
		logger.info(getTextures().size()+" textures coordinates.");
