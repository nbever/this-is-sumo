...
public class Yotsu extends TachiAiAction
{
	...
	public Yotsu( RikishiStatus myStatus, FightKnowledgeIf callback )
	{
	...
	public List<SEQUENCE_KEY> getSequence() {
		return Arrays.asList( SEQUENCE_KEY.TOWARD, SEQUENCE_KEY.UP, SEQUENCE_KEY.DOWN, SEQUENCE_KEY.TOWARD, SEQUENCE_KEY.UP, 
