...
public class Henka extends TachiAiAction
{
	...
	public Henka( RikishiStatus myStatus, FightKnowledgeIf callback )
	{
	...
	public List<SEQUENCE_KEY> getSequence() {
		return Arrays.asList( SEQUENCE_KEY.AWAY, SEQUENCE_KEY.UP, SEQUENCE_KEY.RANDOM, SEQUENCE_KEY.RANDOM, SEQUENCE_KEY.DOWN, SEQUENCE_KEY.RANDOM,
			SEQUENCE_KEY.AWAY, SEQUENCE_KEY.RANDOM, SEQUENCE_KEY.UP, SEQUENCE_KEY.RANDOM );
	}
